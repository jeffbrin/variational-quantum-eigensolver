...
distances = np.linspace(0.2, 3, 200)
...
ax.annotate(f"({round(equilibrium_distance, 3)}, {round(min_gs_energy, 3)})", (equilibrium_distance-0.2, min_gs_energy+0.1))
plt.title("$H_2$ Ground State Potential Energy vs. Interatomic Distance")
